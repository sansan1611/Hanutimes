    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="about.php" class="nav-link">Team</a></li>
        ...
        <div class="col-md-6 pl-md-5 py-md-5">
          <div class="row justify-content-start pt-3 pb-3">
            <div class="col-md-12 heading-section ftco-animate">
              <span class="subheading">Welcome to HanuTimes</span>
              <h2 class="mb-4">We give you the best news you want.</h2>
              <p>This is our final project in IWS Course, Spring 2020.</p>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-md-7 text-center heading-section ftco-animate">
          <span class="subheading">IWS - Spring 2020</span>
          <h2 class="mb-4">CodeForFun Team</h2>
        </div>
      </div>
