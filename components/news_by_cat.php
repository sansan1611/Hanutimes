...
<div class="row mt-5">
    <div class="col text-center">
        <div class="block-27">
            ...
            <ul>
                <li class="first-btn"><a href="category.php?id=<?php echo $id; ?>&&page=1" style="border: none; <?php if ($page == $pagemin) echo 'display: none;' ?>">&lt; &lt;</a></li>
                ...
                <li class="last-btn"><a href="category.php?id=<?php echo $id; ?>&&page=<?php echo $total_page; ?>" style="border: none; <?php if ($page == $pagemax) echo 'display: none;' ?>">&gt; &gt;</a></li>
            </ul>
        </div>
    </div>
</div>