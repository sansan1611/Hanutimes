	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="template/index.html" class="nav-link">Home</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
          	<p class="mb-5">
              <img src="images/<?php echo $result['pic']?>.jpg" alt="" class="img-fluid">
            </p>
            <h6><?php echo $result['author']?>, <?php echo $result['created_date']?> </h6>
